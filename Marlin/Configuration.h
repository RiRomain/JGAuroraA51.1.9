...
/**
 * JGAurora A5 3D Printer Firmware V1.1.9
 * Based on 1.1.8C by: Telli Mantelli, Kris Waclawski, Michael Gilardi & Samuel Pinches
 * github.com/GilardiLabs/Marlin
 *
 * This configuration of Marlin was created by the community for the 
 * JGAurora A5 3D printer community. A BIG thanks to the Marlin developers
...
#define STRING_CONFIG_H_AUTHOR "Prepared by Sam Pinches, 20/8/18" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 "Marlin 1.1.9C - Community Firmware for A5" // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "JGAurorawiki.com/A5"          // will be shown during bootup in line 2
